...
//        -=     *=     /=     %=
        ...
        //Primero se incrementa la variable y después su valor
        ...
        System.out.println("varG = " + varG); //Se incremente en la unidad
        System.out.println("varH = " + varH); //Va a sumar uno
        ...
        //Postdecremento
        var varK = 8;
        var varL = varK--; //Priemro el valor de la variable, luego queda el decremento
