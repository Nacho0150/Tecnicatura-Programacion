...
# print(persona1.nombre) # Tarea: Hacer print igual que con el objeto 2
# print(persona1.apellido)
# print(persona1.edad)
print(f'El objeto1 de la clase persona: {persona1.nombre} {persona1.apellido} Su edad es: {persona1.edad}')

persona2 = Persona('Osvaldor', 'Giordini', 303221456, 45)
...
# print(persona2.telefono) # El objeto pesona2 no tiene este atributo, da error
